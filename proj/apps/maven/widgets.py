...
class MavenStandardMixin(forms.TextInput):
    ...
    class Media:
        css = {
            'all': (
                settings.STATIC_URL + 'maven/dialog/dialog.css',
        ...
        js = (
            ...
            settings.STATIC_URL + 'maven/jquery/jquery.min.js',
            settings.STATIC_URL + 'maven/fontawesome/all.js',
            settings.STATIC_URL + f'maven/dialog/dialog.js?version={TS}',
